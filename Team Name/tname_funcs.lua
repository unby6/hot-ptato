                    ...
                    {n=G.UIT.C, config={align = "cm", padding = 0.2, r=0.2, colour = G.C.L_BLACK, emboss = 0.05, minw = 8.2}, nodes={
                      {n=G.UIT.R, config={id = "plinking_area", align = "cm", colour = G.C.BLACK, }, nodes={
                            ...
                            {n=G.UIT.C, config={id = "plinking_area", align = "cm", colour = G.C.BLACK, padding = 0., minw = 2.3, minh = 1.9}, nodes={
                                {n = G.UIT.R, config = {align = "cm",minw = G.CARD_W, minh = G.CARD_H}, nodes = {{n = G.UIT.O, config = {object = G.wheel_area, align = "cm"}}}},
                                {n = G.UIT.R, config = {align = "cm",minw = G.CARD_W, minh = G.CARD_H}, nodes = {{n = G.UIT.O, config = {object = G.wheel_area4, align = "cm"}}}},
                                {n = G.UIT.R, config = {align = "cm",minw = G.CARD_W, minh = G.CARD_H}, nodes = {{n = G.UIT.O, config = {object = G.wheel_area7, align = "cm"}}}},

                            }},
                            {n=G.UIT.C, config={id = "plinking_area2", align = "cm", colour = G.C.BLACK, padding = 0., minw = 2.3, minh = 1.9}, nodes={
                                {n = G.UIT.R, config = {align = "cm",minw = G.CARD_W, minh = G.CARD_H}, nodes = {{n = G.UIT.O, config = {object = G.wheel_area2, align = "cm"}}}},
                                {n = G.UIT.R, config = {align = "cm",minw = G.CARD_W, minh = G.CARD_H}, nodes = {{n = G.UIT.O, config = {object = G.wheel_area5, align = "cm"}}}},
                                {n = G.UIT.R, config = {align = "cm",minw = G.CARD_W, minh = G.CARD_H}, nodes = {{n = G.UIT.O, config = {object = G.wheel_area8, align = "cm"}}}},

                            }},
                            {n=G.UIT.C, config={id = "plinking_area3", align = "cm", colour = G.C.BLACK, padding = 0., minw = 2.3, minh = 1.9}, nodes={
                                {n = G.UIT.R, config = {align = "cm",minw = G.CARD_W, minh = G.CARD_H}, nodes = {{n = G.UIT.O, config = {object = G.wheel_area3, align = "cm"}}}},
                                {n = G.UIT.R, config = {align = "cm",minw = G.CARD_W, minh = G.CARD_H}, nodes = {{n = G.UIT.O, config = {object = G.wheel_area6, align = "cm"}}}},
                                {n = G.UIT.R, config = {align = "cm",minw = G.CARD_W, minh = G.CARD_H}, nodes = {{n = G.UIT.O, config = {object = G.wheel_area9, align = "cm"}}}},
