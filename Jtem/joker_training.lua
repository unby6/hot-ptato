...
SMODS.Consumable {
	...
	pos = { x = 0, y = 0 },
	config = { max_highlighted = 1, hpot_train_increase = { speed = 22, power = 11 }, hpot_energy_change = -10 },
...
SMODS.Consumable {
	...
	atlas = 'jtem_training_tarots',
	pos = { x = 1, y = 0 },
	config = { max_highlighted = 1, hpot_train_increase = { stamina = 24, guts = 10 }, hpot_energy_change = -10 },
	can_use = hpot_training_tarot_can_use,
	use = hpot_training_tarot_use,
	loc_vars = hpot_training_tarot_loc_vars,
	hotpot_credits = training_tarot_credits,
...
SMODS.Consumable {
	...
	atlas = 'jtem_training_tarots',
	pos = { x = 2, y = 0 },
	config = { max_highlighted = 1, hpot_train_increase = { power = 18, stamina = 8 }, hpot_energy_change = -10 },
	can_use = hpot_training_tarot_can_use,
	use = hpot_training_tarot_use,
	loc_vars = hpot_training_tarot_loc_vars,
	hotpot_credits = training_tarot_credits,
...
SMODS.Consumable {
	...
	atlas = 'jtem_training_tarots',
	pos = { x = 3, y = 0 },
	config = { max_highlighted = 1, hpot_train_increase = { guts = 20, speed = 7, power = 8 }, hpot_energy_change = -10 },
	can_use = hpot_training_tarot_can_use,
	use = hpot_training_tarot_use,
	loc_vars = hpot_training_tarot_loc_vars,
	hotpot_credits = training_tarot_credits,
...
SMODS.Consumable {
	...
	atlas = 'jtem_training_tarots',
	pos = { x = 1, y = 1 },
	config = { max_highlighted = 1, hpot_train_increase = {}, hpot_energy_change = 60, hpot_skip_fail_check = true },
	can_use = hpot_training_tarot_can_use,
	use = hpot_training_tarot_use,
	loc_vars = hpot_training_tarot_loc_vars,
	hotpot_credits = training_tarot_credits,
