...
function create_card(_type, area, legendary, _rarity, skip_materialize, soulable, forced_key, key_append)
    ...
    if card.ability.consumeable and card.ability.consumeable.max_highlighted then
        card.ability.consumeable.max_highlighted = card.ability.consumeable.max_highlighted + G.GAME.max_highlighted_mod
    ...
    elseif card.ability and card.ability.max_highlighted then
        card.ability.max_highlighted = card.ability.max_highlighted + G.GAME.max_highlighted_mod
