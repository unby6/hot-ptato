...
G.FUNCS.nursery_ready = function(e)
    if (#G.nursery_father.cards == 1 or G.GAME.parthenogenesis) and #G.nursery_mother.cards == 1 and #G.nursery_child.cards == 0 and not G.GAME.active_breeding and ((G.GAME.dollars-G.GAME.bankrupt_at) - 3 >= 0) then
